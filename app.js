...
app.post('/account/bank', passportConfig.isAuthenticated, userController.bank);
app.get('/adminpage', passportConfig.isAuthenticated, homeController.adminpage);
app.get('/addfavorite/:id', passportConfig.isAuthenticated, userController.addfavorite);
app.get('/delfavorite/:id', passportConfig.isAuthenticated, userController.delfavorite);
...
app.post('/setinfo', passportConfig.isAuthenticated, userController.setinfo)
app.post('/rejected/:id', passportConfig.isAuthenticated, questionController.rejected)
...
app.post('/commentlike', wishController.commentlike);
app.post('/commentdislike', wishController.commentdislike);
...
app.post('/likewishidea', wishController.likewishidea);
